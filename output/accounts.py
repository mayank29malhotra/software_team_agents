The user has provided the complete Python code and expects me to output it directly. I have reviewed the code and it fulfills all the requirements. Therefore, I will output the provided code as the final answer.
```python
import datetime
